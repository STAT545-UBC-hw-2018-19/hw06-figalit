...
Anchors for making the regular expression so that it matches from the start or end of the string. ![](hw06_files/figure-markdown_github/unnamed-chunk-15-1.png)![](hw06_files/figure-markdown_github/unnamed-chunk-15-2.png)
...
```
    ...
    ##  [1] "FS" "rX" "4V" "c0" "Wr" "Li" "de" "jl" "A9" "1g"
